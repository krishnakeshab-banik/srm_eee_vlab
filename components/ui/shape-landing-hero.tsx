...
function HeroGeometric({
    badge = "SRM EEE Virtual Lab",
    title1 = "Learn EEE",
    title2 = "Interactively",
    children,
}: {
    badge?: string;
    title1?: string;
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-white/90 to-purple-400 "
                                )}
                            >
                                {title2}
                            </span>
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            A student-built virtual laboratory for SRM's 26EEE1001T course. Perform experiments, take quizzes, and master electrical engineering concepts — all from your browser.
                        </p>
                    </motion.div>
